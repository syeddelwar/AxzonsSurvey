...
// Zubayer
const SurveyQuestion = ({surveyUserData, setSurveyUserData}) => {
  const router = useRouter() // Zubayer
  ...
  const handleSubmit = (e) => {
    e.preventDefault()
    fetch("http://localhost:3000/api/addToDB",{
      method: "POST",
      headers: {
        "content-type": "application/json"
      },
      body: JSON.stringify({surveyUserData, surveyResult: selectedOptions})
    })
