      ...
      <div className="">
        <div className="flex flex-col lg:flex-row justify-between">
          ...
          <div className="right-section w-full lg:w-[60%] pb-16 lg:pb-5">
            ...
            >
              {showSurvey ? (
                <SurveyQuestion surveyUserData={surveyUserData} setSurveyUserData={setSurveyUserData} />
              ) : (
                <>
                  <LeftHeading surveyUserData={surveyUserData} setSurveyUserData={setSurveyUserData} />
